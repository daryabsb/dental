                                ...
                                <div class="card-body">
                                    <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                        <li class="nav-item" v-for="tab in tabs" :key="tab.name">
                                            <a  @click="setActiveTabName(tab.name)"
                                            class="nav-link" 
                                             id="general_detail_tab" data-toggle="pill"
                                            :class="{active: tab.name === activeTabName}">{{tab.displayName}}</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-content detail-list">
                                <div v-if="displayContents('tabGeneral')">
                                    <div class="row">
                                        <div class="col-12">                                            
                                            <div class="card">
                                                <div class="card-body">
                                ...
                                <div v-if="displayContents('tabTreatment')">                                                
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card">                                       
                                                <div class="card-body"> 
                                ...
                                <div v-if="displayContents('tabFiles')">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="card">
                                                <div class="card-body">
                                ...
                                <div v-if="displayContents('tabAppointments')">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
