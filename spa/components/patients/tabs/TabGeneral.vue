						...
						<b-row>
							<b-col>
								<b-card>
									...
									<b-card-body>
										<span
											class="float-right text-muted font-weight-normal"
										>These examinations were updated on: {{$moment(examinations.updated).format('DD/MM/yyyy')}}</span>
										<h2 class="text-pink text-uppercase mt-0"></h2>
							...
							<div class="col-lg-4">
								<div class="card">
									<div class="card-body">
										<img style="width: 7rem;" class="float-right" src="~assets/images/ex/skeletal.svg" alt />
								...
								<div class="card">
									<div class="card-body">
										<img
											style="width: 7rem;"
											class="float-right"
											src="~assets/images/ex/nasolabial-angle.svg"
											alt
										/>
										<!-- <span class="float-right text-muted font-weight-normal">
