...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"http://127.0.0.1:8000/api/user/token/","method":"POST","propertyName":"token","altProperty":"refresh"},"logout":true,"user":{"url":"http://127.0.0.1:8000/api/user/me","method":"get","propertyName":false}},"tokenType":"Token ","_name":"local"}))
